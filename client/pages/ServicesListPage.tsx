            ...
            <div>
                ...
                <div>
                    {categories.map(category => (
                        <label key={category} className="group flex items-center space-x-3 cursor-pointer py-1 px-2 rounded-md transition-colors hover:bg-brand-secondary">
                             <input
                                type="checkbox"
                                name="category"
                                value={category}
                                checked={category === 'Tất cả' ? selectedCategories.length === 0 : selectedCategories.includes(category)}
                            ...
                            />
                            <span className="text-base text-gray-700 transition-colors group-hover:text-brand-dark">{category}</span>
                        </label>
                    ))}
                </div>
            </div>
