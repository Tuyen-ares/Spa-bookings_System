  ...
  async up(queryInterface, Sequelize) {
    const promotions = [
      ...
      },
      {
        ...
        description: 'Voucher đặc biệt cho gói chăm sóc spa trọn ngày. Giảm 25% cho các dịch vụ spa.',
        code: 'SPADAY25',
        discountType: 'percentage',
        discountValue: 25,
        expiryDate: '2025-12-31',
      ...
      {
        id: 'promo-19',
        title: 'Voucher Triệt Lông - Giảm 300,000 VNĐ',
        description: 'Voucher chuyên biệt cho dịch vụ triệt lông. Giảm 300,000 VNĐ cho dịch vụ triệt lông.',
        code: 'HAIR300K',
        discountType: 'fixed',
        ...
        minOrderValue: 2000000,
        stock: 35,
        pointsRequired: 280, // Đổi bằng 280 điểm
      },
      {
        id: 'promo-20',
